...
public static void main(String[] args)
{
	...
	int x2= s.nextInt();
	int x3=rule.sum(x1, x2);
	System.out.println("Sum of First and Second number is "+x3);
	...
	System.out.println("Enter Fifth number which you want to divide by above result.");
	int x8= s.nextInt();
	int x9=rule.div(x7, x8);
